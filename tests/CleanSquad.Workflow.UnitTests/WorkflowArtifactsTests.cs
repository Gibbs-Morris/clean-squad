...
public sealed class WorkflowArtifactsTests
{
    ...
    public void CreateUsesDeterministicRunPaths()
    {
        ...
        Assert.EndsWith(".workflow-testing\\workflow-runs\\20260411-120000-request", artifacts.RunDirectoryPath,
    ...
    public void CreateUsesConfiguredStorageDirectories()
    {
        ...
        Assert.EndsWith(".runtime-data\\runs\\20260411-120000-request", artifacts.RunDirectoryPath,
            StringComparison.Ordinal);
    }
}
