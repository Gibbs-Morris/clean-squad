...
public static class CleanupChecklistService
{
    ...
    public static IReadOnlyList<CleanTask> CreateStarterChecklist(
        string? squadName,
    ...
    private static IReadOnlyList<CleanTask> CreateStarterChecklistCore(
        string normalizedSquadName,
